...
export const Configurator: React.FC = () => {
  ...
  return (
    <div className="flex flex-col min-h-screen md:h-screen w-full bg-[#f8fafc] text-[#0f172a] overflow-y-auto md:overflow-hidden font-sans">
      ...
      <header className="h-14 border-b border-[#082247] bg-[#0B2F64] px-4 sm:px-6 flex items-center justify-between z-30 flex-shrink-0 sticky top-0 shadow-sm">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-sm sm:text-base md:text-lg font-bold tracking-tight text-white uppercase font-sans">
              SYAMANAH GARMEN
            </h1>
          </div>
        </div>
        ...
        <div className="flex items-center gap-2 sm:gap-3">
          ...
          <button
            ...
            className="flex items-center gap-1.5 px-2.5 sm:px-3 py-1.5 rounded-lg bg-white/10 hover:bg-white/20 text-white border border-white/20 text-xs font-medium transition-colors"
            title="Lihat Arsitektur & Panduan Integrasi"
          >
          ...
          <button
            ...
            className="flex items-center gap-1.5 sm:gap-2 px-3 sm:px-3.5 py-1.5 rounded-lg bg-[#0D9488] hover:bg-[#0f766e] text-white text-xs font-bold transition-all shadow-xs active:scale-95 cursor-pointer"
          >
            ...
            <div className="flex items-center justify-between px-6 py-4 border-b border-slate-200 bg-white">
              <div className="flex items-center gap-2">
                ...
                <h3 className="text-base font-bold text-slate-900">
                  Dokumentasi Teknis & Panduan Pengembang (MVP)
                </h3>
              </div>
              <button
