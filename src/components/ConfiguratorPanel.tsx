...
export const ConfiguratorPanel: React.FC<ConfiguratorPanelProps> = ({
  ...
  return (
    ...
    >
      ...
      {/* Top Action Bar: SAVE DESIGN & DOKUMENTASI */}
      <div className="px-4 py-2.5 bg-slate-50/90 border-b border-[#e2e8f0] flex items-center gap-2 flex-shrink-0">
        <button
          id="btn-header-save"
          onClick={onSave}
          className="flex-1 flex items-center justify-center gap-2 py-2 px-3 bg-indigo-600 hover:bg-indigo-700 active:scale-[0.98] text-white font-bold rounded-lg text-xs shadow-xs transition-all cursor-pointer"
        ...
        {onOpenDocs && (
          <button
            ...
            onClick={onOpenDocs}
            className="flex items-center justify-center gap-1.5 py-2 px-3 bg-white hover:bg-slate-100 active:scale-[0.98] text-slate-700 font-semibold rounded-lg border border-slate-200 text-xs transition-colors shadow-2xs cursor-pointer"
