                  ...
                  <div className="relative w-full my-auto flex items-center justify-center px-1">
                    <div className="absolute left-1 top-1/2 -translate-y-1/2">
                      {config.logoUrl ? (
                        ...
                        <div className="w-3.5 h-3.5 rounded border border-dashed border-white/60 flex items-center justify-center text-[5px] text-white font-bold">
                          Crest
                        </div>
                      )}
                    </div>
